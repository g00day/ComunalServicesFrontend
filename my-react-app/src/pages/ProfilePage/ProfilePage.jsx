      ...
      <div className={classes.mainGrid}>
        ...
        <div className={classes.leftColumn}>
          ...
          <div className={`${classes.card} ${classes.emailBox}`}>
            ...
            <img src={mailIcon} className={classes.stat_icn_2} alt="mail" />
          </div>

          <div className={`${classes.card} ${classes.statsBox}`}>
            <h3>Статистика:</h3>
            <div className={classes.statItem}>
              <img src={closedIcn} alt="Закрыто" className={classes.stat_icn_1}/>
              Закрыто заявок: 12
            </div>
            <div className={classes.statItem}>
              <img src={inWorkIcn} alt="В работе" className={classes.stat_icn_2}/>
              Заявок в работе: 0
            </div>
          </div>
        </div>
